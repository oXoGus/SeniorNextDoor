<?php   
    ...
    if (isset($user->avatar)){
        ...
        // si on le binary de l'img est revoyé en tant que resource et nom pas en String 
        ...
        // on utilise on encode les donnée binaire de l'img dans son uri grace a la fonction
